...
#include "ESP31BWiFiMulti.h"
#include <limits.h>
#include <string.h>

ESP31BWiFiMulti::ESP31BWiFiMulti() {
}
...
bool ESP31BWiFiMulti::addAP(const char* ssid, const char *passphrase) {
    return APlistAdd(ssid, passphrase);
}

wl_status_t ESP31BWiFiMulti::run(void) {
...
bool ESP31BWiFiMulti::APlistAdd(const char* ssid, const char *passphrase) {
...
void ESP31BWiFiMulti::APlistClean(void) {
