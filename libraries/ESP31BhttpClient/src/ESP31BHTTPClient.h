 ...
 * This file is part of the ESP31BHTTPClient for Arduino.
 *
...
#ifndef ESP31BHTTPClient_H_
#define ESP31BHTTPClient_H_
...
#define DEBUG_HTTPCLIENT(...) //os_printf( __VA_ARGS__ )
#endif
