...
#define SDA_LOW()   ((twi_sda < 32)?(GPES0 = (1 << twi_sda)):(GPES1 = (1 << (twi_sda - 32)))) //Enable SDA (becomes output and since GPO is 0 for the pin, it will pull the line low)
#define SDA_HIGH()  ((twi_sda < 32)?(GPEC0 = (1 << twi_sda)):(GPEC1 = (1 << (twi_sda - 32)))) //Disable SDA (becomes input and since it has pullup it will go high)
#define SDA_READ()  ((twi_sda < 32)?((GPI0 & (1 << twi_sda)) != 0):((GPI1 & (1 << (twi_sda - 32))) != 0))
#define SCL_LOW()   ((twi_scl < 32)?(GPES0 = (1 << twi_scl)):(GPES1 = (1 << (twi_scl - 32))))
#define SCL_HIGH()  ((twi_scl < 32)?(GPEC0 = (1 << twi_scl)):(GPEC1 = (1 << (twi_scl - 32))))
#define SCL_READ()  ((twi_scl < 32)?((GPI0 & (1 << twi_scl)) != 0):((GPI1 & (1 << (twi_scl - 32))) != 0))
